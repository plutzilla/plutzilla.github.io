...
gulp -f ../gulpfile.js
docker build -t eu.gcr.io/lescinskas-lt/nginx-server:latest -t eu.gcr.io/lescinskas-lt/nginx-server:v9 -f ../nginx.Dockerfile ..
docker push eu.gcr.io/lescinskas-lt/nginx-server:latest
docker push eu.gcr.io/lescinskas-lt/nginx-server:v9
# TODO Deploy to k8s
