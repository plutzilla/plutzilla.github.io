...
gulp -f ../gulpfile.js
docker build -t eu.gcr.io/lescinskas-lt/nginx-server:latest -t eu.gcr.io/lescinskas-lt/nginx-server:v11 -f ../nginx.Dockerfile ..
docker push eu.gcr.io/lescinskas-lt/nginx-server:latest
docker push eu.gcr.io/lescinskas-lt/nginx-server:v12
# TODO Deploy to k8s
